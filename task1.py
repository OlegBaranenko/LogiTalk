...
class RegisterWindow(CTk):
    ...
    def start_chat(self):
        ...
        try:
            ...
            hello = f'TEXT@{self.username}@[SYSTEM]{self.username}приєднатись до чату!\n'
...
class Mainwindow(CTk):
    def __init__(self,sock,username):
        ...
        ,width=200,height=self.winfo_height())
        self.frame.pack_propagate(False)
        self.frame.configure(width=0)
        self.frame.place(x=0,y=0)
        self.is_show_menu = False
        self.frame_width = 0 
        self.btn = CTkButton(self,text='▶️',
        command=self.togle_show_menu, width=30 )
        ...
        self.send_btn = CTkButton(self,width=30,text='▶️',command = self.send_message)
